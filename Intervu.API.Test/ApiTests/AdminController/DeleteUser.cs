...
{
    public class DeleteUserTests : BaseTest, IClassFixture<BaseApiTest<Program>>
    {
        private readonly ApiHelper _api;

        public DeleteUserTests(BaseApiTest<Program> factory, ITestOutputHelper output) : base(output)
        {
        ...
        public async Task DeleteUser_ReturnsSuccess()
        {
            ...
            var email = $"admin_deleted_{Guid.NewGuid()}@example.com";
            ...
            LogInfo($"Creating user {email} for delete flow.");
