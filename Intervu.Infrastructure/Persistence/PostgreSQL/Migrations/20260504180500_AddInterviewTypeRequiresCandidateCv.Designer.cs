...
namespace Intervu.Infrastructure.Persistence.PostgreSQL.Migrations
{
    ...
    [Migration("20260504180500_AddInterviewTypeRequiresCandidateCv")]
    partial class AddInterviewTypeRequiresCandidateCv
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoachIndustries", b =>
                {
                    b.Property<Guid>("CoachProfilesId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("CoachProfilesId", "IndustriesId");

                    b.HasIndex("IndustriesId");

                    b.ToTable("CoachIndustries", (string)null);

                    b.HasData(
                        new
                        {
                            CoachProfilesId = new Guid("1e9f9d3b-5b4c-4f1d-9f3a-8b8c3e2d4c22"),
                            IndustriesId = new Guid("11110000-0000-4000-8000-000000000001")
                        },
                        new
                        {
                            CoachProfilesId = new Guid("1e9f9d3b-5b4c-4f1d-9f3a-8b8c3e2d4c22"),
                            IndustriesId = new Guid("11110000-0000-4000-8000-000000000006")
                        },
                        new
                        {
                            CoachProfilesId = new Guid("3a7b6c5d-7e6f-4d3c-9b8a-7c6d5e4f3b44"),
                            IndustriesId = new Guid("11110000-0000-4000-8000-000000000002")
                        },
                        new
                        {
                            CoachProfilesId = new Guid("3a7b6c5d-7e6f-4d3c-9b8a-7c6d5e4f3b44"),
                            IndustriesId = new Guid("11110000-0000-4000-8000-000000000007")
                        },
                        new
                        {
                            CoachProfilesId = new Guid("4b6c5d7e-8f7a-4c3d-9e8b-6d5c4f3e2a55"),
                            IndustriesId = new Guid("11110000-0000-4000-8000-000000000003")
                        },
                        new
                        {
                            CoachProfilesId = new Guid("4b6c5d7e-8f7a-4c3d-9e8b-6d5c4f3e2a55"),
                            IndustriesId = new Guid("11110000-0000-4000-8000-000000000008")
                        });
                });
            ...
            modelBuilder.Entity("Intervu.Domain.Entities.AiTrafficLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Intervu.Domain.Entities.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Intervu.Domain.Entities.BookingRequest", b =>
                {
                    ...
                    b.Property<string>("RoadmapNodeId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Intervu.Domain.Entities.Industry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("11110000-0000-4000-8000-000000000001"),
                            Name = "Fintech",
                            Slug = "fintech"
                        },
                        new
                        {
                            Id = new Guid("11110000-0000-4000-8000-000000000002"),
                            Name = "E-commerce",
                            Slug = "e-commerce"
                        },
                        new
                        {
                            Id = new Guid("11110000-0000-4000-8000-000000000003"),
                            Name = "EdTech",
                            Slug = "edtech"
                        },
                        new
                        {
                            Id = new Guid("11110000-0000-4000-8000-000000000004"),
                            Name = "Blockchain",
                            Slug = "blockchain"
                        },
                        new
                        {
                            Id = new Guid("11110000-0000-4000-8000-000000000005"),
                            Name = "HealthTech",
                            Slug = "healthtech"
                        },
                        new
                        {
                            Id = new Guid("11110000-0000-4000-8000-000000000006"),
                            Name = "SaaS",
                            Slug = "saas"
                        },
                        new
                        {
                            Id = new Guid("11110000-0000-4000-8000-000000000007"),
                            Name = "AI/ML",
                            Slug = "ai-ml"
                        },
                        new
                        {
                            Id = new Guid("11110000-0000-4000-8000-000000000008"),
                            Name = "GameDev",
                            Slug = "gamedev"
                        });
                });
            ...
            modelBuilder.Entity("Intervu.Domain.Entities.InterviewBookingTransaction", b =>
                {
                    ...
                    b.HasIndex("InterviewRoundId", "Type")
            ...
            modelBuilder.Entity("Intervu.Domain.Entities.InterviewReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("InterviewRoomReports", (string)null);
                });
            ...
            modelBuilder.Entity("Intervu.Domain.Entities.InterviewType", b =>
                {
                    ...
                    b.Property<bool>("RequiresCandidateCv")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("Intervu.Domain.Entities.PlatformSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("019d9aa0-0000-7000-8000-000000000001"),
                            CommissionRate = 0.30m,
                            CreatedAt = new DateTime(2026, 4, 19, 0, 0, 0, 0, DateTimeKind.Utc)
                        });
                });

            modelBuilder.Entity("Intervu.Domain.Entities.PreparedQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("InterviewRoomId", "SortOrder")
                        .HasDatabaseName("IX_PreparedQuestions_InterviewRoomId_SortOrder");

                    b.ToTable("PreparedQuestions", (string)null);
                });
            ...
            modelBuilder.Entity("Intervu.Domain.Entities.UserAssessmentAnswer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Intervu.Domain.Entities.UserSkillAssessmentSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Intervu.Domain.Entities.PreparedQuestion", b =>
                {
                    b.HasOne("Intervu.Domain.Entities.InterviewRoom", "InterviewRoom")
                        .WithMany("PreparedQuestions")
                        .HasForeignKey("InterviewRoomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_PreparedQuestions_InterviewRooms_InterviewRoomId");

                    b.HasOne("Intervu.Domain.Entities.Question", null)
                        .WithMany()
                        .HasForeignKey("SourceBankQuestionId")
                        .OnDelete(DeleteBehavior.SetNull)
            ...
            modelBuilder.Entity("Intervu.Domain.Entities.InterviewRoom", b =>
                {
                    ...
                    b.Navigation("PreparedQuestions");
